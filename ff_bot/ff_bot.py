...
def get_last_place_team(league):
	return league.standings()[-1]

def get_trophies(league, week=None):
	#Gets trophies for highest score, lowest score, closest score, and biggest win
	if not week:
		week = power_rankings_week(league)
	...
	if biggest_blowout >= 20:
		...
		last_place_team = get_last_place_team(league)
		blowout_str = ["No teams were destroyed this week. (Good job {}!)".format(last_place_team.owner.split(" ")[0])]
